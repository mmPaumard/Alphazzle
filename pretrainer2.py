...
from lib.puzzles_generator_MET import prepare_data_p, prepare_data_v, prepare_data_new
...
def main():
    ...
    for e in range(NB_EPOCHS):
        ...
        print('')
        lossPval, accPval = model_r.evaluate_generator(dataset_valid_p)
        lossVval, accVval = model_r_v.evaluate_generator(dataset_valid_v)
        ...
        if accVval > bestV:
            bestV = accVval
            model_r_v.save_weights(filepath_v.format(epoch=e, val_acc=accVval))
